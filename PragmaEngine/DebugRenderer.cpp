...
PragmaEngine::DebugRenderer::DebugRenderer() {
    // Empty
}
...
void PragmaEngine::DebugRenderer::init() {
...
void PragmaEngine::DebugRenderer::end() {
    glBindBuffer(GL_ARRAY_BUFFER, m_vbo);
    // Orphan the buffer
...
void PragmaEngine::DebugRenderer::drawBox(const glm::vec4& destRect, const ColorRGBA8& color, float angle) {
...
void PragmaEngine::DebugRenderer::drawCircle(const glm::vec2& center, const ColorRGBA8& color, float radius) {
...
void PragmaEngine::DebugRenderer::render(const glm::mat4& projectionMatrix, float lineWidth) {
    m_program.use();
...
void PragmaEngine::DebugRenderer::dispose() {
    if (m_vao) {
