...
class Grid {
public:
	void init(float levelWidth, float levelHeight, PragmaEngine::ParticleBatch2D* bloodParticleBatch);

	void draw(PragmaEngine::SpriteBatch& spriteBatch, PragmaEngine::Camera2D& camera);
...
private:
	...
	PragmaEngine::ParticleBatch2D* m_bloodParticleBatch = nullptr;
