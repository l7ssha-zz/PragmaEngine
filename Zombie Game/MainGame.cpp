...
void MainGame::initLevel() {
	...
	m_player->addGun(new Gun("Magnum", 10, 1, 5.0f, 30, BULLET_SPEED, "Sound/shots/pistol.wav"));
	m_player->addGun(new Gun("Shotgun", 30, 12, 20.0f, 4, BULLET_SPEED, "Sound/shots/shotgun.wav"));
	m_player->addGun(new Gun("MP5", 2, 1, 10.0f, 20, BULLET_SPEED, "Sound/shots/cg1.wav"));
}
