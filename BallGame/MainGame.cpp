...
#define ADD_BALL(p, ...) \
    ...
    ADD_BALL(1.0f, PragmaEngine::ColorRGBA8(255, 255, 255, 255),
             2.0f, 1.0f, 0.1f, 7.0f, totalProbability);
    ADD_BALL(1.0f, PragmaEngine::ColorRGBA8(1, 254, 145, 255),
             2.0f, 2.0f, 0.1f, 3.0f, totalProbability);
    ADD_BALL(1.0f, PragmaEngine::ColorRGBA8(177, 0, 254, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability)
    ADD_BALL(1.0f, PragmaEngine::ColorRGBA8(254, 0, 0, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    ADD_BALL(1.0f, PragmaEngine::ColorRGBA8(0, 255, 255, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
